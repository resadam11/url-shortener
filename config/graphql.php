...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'short_link' => \App\GraphQL\Queries\ShortLink\ShortLinkQuery::class,
                'short_links' => \App\GraphQL\Queries\ShortLink\ShortLinksQuery::class,
                'redirect_logs' => \App\GraphQL\Queries\RedirectLog\RedirectLogsQuery::class
            ],
            'mutation' => [
                'createShortLink' => \App\GraphQL\Mutations\ShortLink\CreateShortLinkMutation::class,
                'updateShortLink' => \App\GraphQL\Mutations\ShortLink\UpdateShortLinkMutation::class,
                'deleteShortLink' => \App\GraphQL\Mutations\ShortLink\DeleteShortLinkMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                'ShortLink' => \App\GraphQL\Types\ShortLinkType::class,
                'RedirectLog' => \App\GraphQL\Types\RedirectLogType::class,
            ],
